...
import { 
  ...
  Clock, UserX, CheckCircle2, Filter, ChevronRight, MoreHorizontal, Zap
} from 'lucide-react';
    ...
    async function fetchUsers() {
      ...
      try {
        ...
        const userData = querySnapshot.docs.map(doc => ({ 
          ...
          usage: Math.floor(Math.random() * 5), // Mock usage for demo
              ...
              {loading ? (
                ...
                <tr key={u.id} className="hover:bg-slate-50/50 transition-all group">
                  ...
                  <td className="px-8 py-6 text-right">
                    <button className="h-10 w-10 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-400 hover:text-blue-600 hover:border-blue-200 hover:bg-blue-50 transition-all ml-auto">
