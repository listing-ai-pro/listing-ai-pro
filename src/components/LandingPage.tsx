...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfdfe] font-sans selection:bg-blue-100 selection:text-blue-900">
      {/* Landing Header */}
      <header className="fixed top-0 left-0 right-0 h-20 lg:h-24 bg-white/80 backdrop-blur-xl border-b border-slate-100 px-4 lg:px-12 flex items-center justify-between z-50">
        <div className="flex items-center gap-3 lg:gap-4">
          ...
          <div>
            ...
            <p className="text-[8px] lg:text-[10px] font-black text-blue-600 tracking-[0.2em] uppercase mt-1">Enterprise</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          <button 
            onClick={() => setShowAuth(true)}
            className="flex items-center gap-2 px-5 lg:px-8 py-3 lg:py-3.5 rounded-xl lg:rounded-2xl bg-slate-900 text-white font-black text-[9px] lg:text-[10px] uppercase tracking-widest hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/10 active:scale-95"
          >
